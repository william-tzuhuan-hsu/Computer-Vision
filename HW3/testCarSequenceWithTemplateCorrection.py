...
rect_origin = [59, 116, 145, 151]
rect = copy.deepcopy(rect_origin)

# (240, 320, 415)
# print(seq.shape)

rect_list = np.load("carseqrects.npy")
rect_list_WT = []
...
for i in range(seq.shape[2]-1):
    ...
    # if i in [1, 20, 40, 60, 80, 100, 200, 300, 400, 414]:
        ...
        plt.savefig('car_frame'+str(i+1)+'_withCorrection.png')


np.save("carseqrects-wcrt.npy", np.array(rect_list_WT))